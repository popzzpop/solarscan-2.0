...
<svelte:head>
  <title>Ghawdex Engineering Solar Analyzer for Malta</title>
  <meta name="description" content="Professional solar potential analysis tool for Malta developed by Ghawdex Engineering" />
</svelte:head>
